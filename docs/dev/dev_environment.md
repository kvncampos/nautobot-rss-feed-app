...
- `project_name`: the default docker compose project name (default: `ntc-news-feed`)
...
#14 naming to docker.io/ntc-news-feed/nautobot:2.0.0-py3.11 done
```
...
Creating network "ntc_news_feed_default" with the default driver
Creating volume "ntc_news_feed_postgres_data" with default driver
Creating ntc_news_feed_redis_1 ...
Creating ntc_news_feed_docs_1  ...
Creating ntc_news_feed_postgres_1 ...
Creating ntc_news_feed_postgres_1 ... done
Creating ntc_news_feed_redis_1    ... done
Creating ntc_news_feed_nautobot_1 ...
Creating ntc_news_feed_docs_1     ... done
Creating ntc_news_feed_nautobot_1 ... done
Creating ntc_news_feed_worker_1   ...
Creating ntc_news_feed_worker_1   ... done
...
ee90fbfabd77   ntc-news-feed/nautobot:2.0.0-py3.11  "nautobot-server rqw…"   16 seconds ago   Up 13 seconds                                               ntc_news_feed_worker_1
b8adb781d013   ntc-news-feed/nautobot:2.0.0-py3.11  "/docker-entrypoint.…"   20 seconds ago   Up 15 seconds   0.0.0.0:8080->8080/tcp, :::8080->8080/tcp   ntc_news_feed_nautobot_1
d64ebd60675d   ntc-news-feed/nautobot:2.0.0-py3.11  "mkdocs serve -v -a …"   25 seconds ago   Up 18 seconds   0.0.0.0:8001->8080/tcp, :::8001->8080/tcp   ntc_news_feed_docs_1
e72d63129b36   postgres:13-alpine               "docker-entrypoint.s…"   25 seconds ago   Up 19 seconds   0.0.0.0:5432->5432/tcp, :::5432->5432/tcp   ntc_news_feed_postgres_1
96c6ff66997c   redis:6-alpine                   "docker-entrypoint.s…"   25 seconds ago   Up 21 seconds   0.0.0.0:6379->6379/tcp, :::6379->6379/tcp   ntc_news_feed_redis_1
```
...
Stopping ntc_news_feed_worker_1   ...
Stopping ntc_news_feed_nautobot_1 ...
Stopping ntc_news_feed_docs_1     ...
Stopping ntc_news_feed_redis_1    ...
Stopping ntc_news_feed_postgres_1 ...
Stopping ntc_news_feed_worker_1   ... done
Stopping ntc_news_feed_nautobot_1 ... done
Stopping ntc_news_feed_postgres_1 ... done
Stopping ntc_news_feed_redis_1    ... done
Stopping ntc_news_feed_docs_1     ... done
Removing ntc_news_feed_worker_1   ...
Removing ntc_news_feed_nautobot_1 ...
Removing ntc_news_feed_docs_1     ...
Removing ntc_news_feed_redis_1    ...
Removing ntc_news_feed_postgres_1 ...
Removing ntc_news_feed_postgres_1 ... done
Removing ntc_news_feed_docs_1     ... done
Removing ntc_news_feed_worker_1   ... done
Removing ntc_news_feed_redis_1    ... done
Removing ntc_news_feed_nautobot_1 ... done
Removing network ntc_news_feed_default
```
...
So for example, our app is named `ntc-news-feed`, the command would most likely be `docker logs ntc_news_feed_nautobot_1 -f`. You can find the name of all running containers via `docker ps`.
...
```python
namespace = Collection("ntc_news_feed")
namespace.configure(
    {
        "ntc_news_feed": {
            ...
...
Or set the `INVOKE_NTC_NEWS_FEED_PYTHON_VER` variable.
...
Or set the `INVOKE_NTC_NEWS_FEED_NAUTOBOT_VER` variable.
...
In the package source, there is the `ntc_news_feed/app-config-schema.json` file, conforming to the [JSON Schema](https://json-schema.org/) format. This file is used to validate the configuration of the app in CI pipelines.
